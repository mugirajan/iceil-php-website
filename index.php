...
<!-- laptop and tab slider start-->
<div class="slider-landing-tabandlap-view">
	<div class="">
		...
		<div class="swiper-wrapper">
							...
							<div class="container-fluid">
								<div class="mry-main-title"  data-swiper-parallax-scale=".7" data-swiper-parallax-opacity="0"
									...
									<div class="row">
										...
										<div class="col-lg-5 col-sm-12 heading-land d-flex align-self-center">
											<div class="mry-text mry-mb-30 text-light font-weight-normal"> 
												Iceil RGB Dynamic Stretch Ceiling combines innovative lighting technology with flexible design, allowing colorful lighting to be implemented through addressable, programmable LEDs and DMX controls.</div>
										</div>
										<div class="col-lg-3 col-sm-12 d-flex colbtn align-self-center align-items-center justify-content-center">
											<a class="mry-btn mry-default-link mry-anima-link mry-btn-fill-white" href="RGB">Click here</a>
											<a class="mry-btn-text mry-default-link mry-anima-link mry-btn-text-white" href="Home">Visit Website</a>
										</div>
									</div>
								</div>
							...
							<div class="container-fluid">
								<div class="mry-main-title"  data-swiper-parallax-scale=".7" data-swiper-parallax-opacity="0"
									...
									<div class="row">
										...
										<div class="col-lg-3 col-sm-12 d-flex colbtn align-self-center align-items-center justify-content-center">
											<a class="mry-btn mry-default-link mry-anima-link mry-btn-fill-white" href="Printed-Lacquer-Ceilings">Click here</a>
											<a class="mry-btn-text mry-default-link mry-anima-link mry-btn-text-white" href="Home">Visit Website</a>
										</div>
									</div>
								</div>
							...
							<div class="container-fluid">
								<div class="mry-main-title"  data-swiper-parallax-scale=".7" data-swiper-parallax-opacity="0"
									...
									<div class="row">
										...
										<div class="col-lg-3 col-sm-12 d-flex colbtn align-self-center align-items-center justify-content-center">
											<a class="mry-btn mry-default-link mry-anima-link mry-btn-fill-white" href="Geometrical">Click here</a>
											<a class="mry-btn-text mry-default-link mry-anima-link mry-btn-text-white" href="Home">Visit Website</a>
										</div>
									</div>
								</div>
							...
							<div class="container-fluid">
								<div class="mry-main-title"  data-swiper-parallax-scale=".7" data-swiper-parallax-opacity="0"
									...
									<div class="row">
										...
										<div class="col-lg-3 col-sm-12 d-flex colbtn align-self-center align-items-center justify-content-center">
											<a class="mry-btn mry-default-link mry-anima-link mry-btn-fill-white" href="ArtPerforated">Click here</a>
											<a class="mry-btn-text mry-default-link mry-anima-link mry-btn-text-white" href="Home">Visit Website</a>
										</div>
									</div>
								</div>
							...
							<div class="container-fluid">
								<div class="mry-main-title"  data-swiper-parallax-scale=".7" data-swiper-parallax-opacity="0"
									...
									<div class="row">
										...
										<div class="col-lg-3 col-sm-12 d-flex colbtn align-self-center align-items-center justify-content-center">
											<a class="mry-btn mry-default-link mry-anima-link mry-btn-fill-white" href="Mirror">Click here</a>
											<a class="mry-btn-text mry-default-link mry-anima-link mry-btn-text-white" href="Home">Visit Website</a>
							...
							<div class="container-fluid">
								<div class="mry-main-title"  data-swiper-parallax-scale=".7" data-swiper-parallax-opacity="0"
									...
									<div class="row">
										...
										<div class="col-lg-3 col-sm-12 d-flex colbtn align-self-center align-items-center justify-content-center">
											<a class="mry-btn mry-default-link mry-anima-link mry-btn-fill-white" href="Metal">Click here</a>
											<a class="mry-btn-text mry-default-link mry-anima-link mry-btn-text-white" href="Home">Visit Website</a>
										</div>
									</div>
								</div>
							...
							<div class="container-fluid">
								<div class="mry-main-title"  data-swiper-parallax-scale=".7" data-swiper-parallax-opacity="0"
									...
									<div class="row">
										...
										<div class="col-lg-3 col-sm-12 d-flex colbtn align-self-center align-items-center justify-content-center">
											<a class="mry-btn mry-default-link mry-anima-link mry-btn-fill-white" href="Fabric-Light-Boxes">Click here</a>
											<a class="mry-btn-text mry-default-link mry-anima-link mry-btn-text-white" href="Home">Visit Website</a>
										</div>
									</div>
								</div>
							...
							<div class="container-fluid">
								<div class="mry-main-title"  data-swiper-parallax-scale=".7" data-swiper-parallax-opacity="0"
									...
									<div class="row">
										...
										<div class="col-lg-3 col-sm-12 d-flex colbtn align-self-center align-items-center justify-content-center">
											<a class="mry-btn mry-default-link mry-anima-link mry-btn-fill-white" href="ARC">Click here</a>
											<a class="mry-btn-text mry-default-link mry-anima-link mry-btn-text-white" href="Home">Visit Website</a>
										</div>
									</div>
								</div>
							...
							<div class="container-fluid">
								<div class="mry-main-title"  data-swiper-parallax-scale=".7" data-swiper-parallax-opacity="0"
									...
									<div class="row">
										...
										<div class="col-lg-3 col-sm-12 d-flex colbtn align-self-center align-items-center justify-content-center">
											<a class="mry-btn mry-default-link mry-anima-link mry-btn-fill-white" href="Surface">Click here</a>
											<a class="mry-btn-text mry-default-link mry-anima-link mry-btn-text-white" href="Home">Visit Website</a>
										</div>
									</div>
								</div>
			...
			<div class="swiper-slide">
				...
				<div class="mry-project-slider-item">
					<div class="mry-project-frame">
						<div class="mry-cover-frame">
							<img class="mry-project-cover" src="images/landing/iceil-landing/linear.jpg" alt="Profile Shape Lighting" data-swiper-parallax="500" data-swiper-parallax-scale="1.4">
							<div class="mry-cover-overlay mry-gradient-overlay"></div>
						</div>
						<div class="mry-main-title-frame">
							<div class="container-fluid">
								<div class="mry-main-title"  data-swiper-parallax-scale=".7" data-swiper-parallax-opacity="0"
									...
									<div class="row">
										...
										<div class="col-lg-2 col-sm-12 d-flex colbtn align-self-center align-items-center justify-content-center">
											<a class="mry-btn mry-default-link mry-anima-link mry-btn-fill-white" href="Curved">Click here</a>
											<a class="mry-btn-text mry-default-link mry-anima-link mry-btn-text-white" href="Home">Visit Website</a>
										</div>
									</div>
								</div>
							...
							<div class="container-fluid">
								<div class="mry-main-title"  data-swiper-parallax-scale=".7" data-swiper-parallax-opacity="0"
									...
									<div class="row">
										...
										<div class="col-lg-3 col-sm-12 d-flex colbtn align-self-center align-items-center justify-content-center">
											<a class="mry-btn mry-default-link mry-anima-link mry-btn-fill-white" href="Outward-Inward">Click here</a>
											<a class="mry-btn-text mry-default-link mry-anima-link mry-btn-text-white" href="Home">Visit Website</a>
										</div>
									</div>
								</div>
...
<div class="hero-slider-container">
    <div class="hero-slider">
        ...
        <div class="hero-slide">
            <img src="images/landing/iceil-landing/1.jpg" alt="Translucent-Stretch-Ceilings">
            <div class="hero-slide-content">
                <h2>Translucent</h2>
                <p>Iceil Translucent Stretch Ceilings allow light to be evenly distributed with the stretch membrane offering 75% Translucency. We can provide a vast seamless lighting solution with a span of 50 SQM without joints creating a great ambiance.
                </p>
                <div class="hero-buttons">
                    <button class="hero-btn"><a href="Translucent-Stretch-Ceilings">Click Here</a></button>
                    <button class="hero-btn"><a href="Home">Visit Website</a></button>
                </div>
            </div>
        </div>
        <!--Printed-->
        <div class="hero-slide">
            <img src="images/landing/iceil-landing/2.jpg" alt="Printed-Stretch-Ceilings">
            <div class="hero-slide-content">
                <h2>Printed</h2>
                <p>Iceil Printed Stretch Ceilings turn any room of your home or business into a work of designer art.The possibilities are endless, giving you the option of enhancing your ceiling with reproductions of famous artists masterwork, or your own art or photographs using modern digital printing techniques on a stretch fabric ceiling installation.</p>
                <div class="hero-buttons">
                    <button class="hero-btn"><a href="Printed-Stretch-Ceilings">Click Here</a></button>
                    <button class="hero-btn"><a href="Home">Visit Website</a></button>
                </div>
            </div>
        </div>
        <!--RGB-->
        <div class="hero-slide">
            <img src="images/landing/iceil-landing/3.jpg" alt="RGB Dynamic">
            <div class="hero-slide-content">
                <h2>RGB Dynamic</h2>
                <p>Iceil RGB Dynamic Stretch Ceiling combines innovative lighting technology with flexible design, allowing colorful lighting to be implemented through addressable, programmable LEDs and DMX controls.
                </p>
                <div class="hero-buttons">
                    <button class="hero-btn"><a href="RGB">Click Here</a></button>
                    <button class="hero-btn"><a href="Home">Visit Website</a></button>
                </div>
            </div>
        </div>
        <!-- 3D Forms -->
        <div class="hero-slide">
            <img src="images/landing/iceil-landing/4.jpg" alt="3D Forms">
            <div class="hero-slide-content">
                <h2> 3D Forms </h2>
                <p>Iceil 3D Form Stretch Ceiling are created by engineering multilevel framing structures using the latest fabrication technologies. Such a Structure can be made to the required size, shape, and then can be fitted with the desired stretch film or printed film.
                </p>
                <div class="hero-buttons">
                    <button class="hero-btn"><a href="3D-Forms-Stretch-Ceilings">Click Here</a></button>
                    <button class="hero-btn"><a href="Home">Visit Website</a></button>
                </div>
            </div>
        </div>
        <!--Acoustic-->
        <div class="hero-slide">
            <img src="images/landing/iceil-landing/5.jpg" alt="Acoustic">
            <div class="hero-slide-content">
                <h2>Acoustic</h2>
                <p>Iceil Acoustic Stretch Ceiling combines sound-absorbing materials with a stretchable perforated fabric, effectively reducing noise levels while maintain- ing an aesthetically pleasing appearance.
                </p>
                <div class="hero-buttons">
                    <button class="hero-btn"><a href="Acoustic">Click Here</a></button>
                    <button class="hero-btn"><a href="Home">Visit Website</a></button>
                </div>
            </div>
        </div>
        <!--Lacquer-->
        <div class="hero-slide">
            <img src="images/landing/iceil-landing/6.jpg" alt="Lacquer">
            <div class="hero-slide-content">
                <h2>Lacquer</h2>
                <p>Iceil Lacquer Stretch Ceiling is a sophisticated ceiling finish characterized by its glossy and reflective surface. Its reflective properties enhance the brightness of the room by bouncing light, while its smooth texture adds a touch of modern elegance.
                </p>
                <div class="hero-buttons">
                    <button class="hero-btn"><a href="Lacquer-Ceilings">Click Here</a></button>
                    <button class="hero-btn"><a href="Home">Visit Website</a></button>
                </div>
            </div>
        </div>
        <!--Printed Lacquer-->
        <div class="hero-slide">
            <img src="images/landing/iceil-landing/7.jpg" alt="Printed Lacquer">
            <div class="hero-slide-content">
                <h2>Printed Lacquer</h2>
                <p>Iceil Printed Lacquer Ceiling allows printing virtually any design or pattern onto Lacquer Stretch Ceiling. This versatility enables the customization of ceilings to match specific aesthetic preferences or complement interior themes, offering endless possibilities for creating unique and personalized spaces.
                </p>
                <div class="hero-buttons">
                    <button class="hero-btn"><a href="Printed-Lacquer-Ceilings">Click Here</a></button>
                    <button class="hero-btn"><a href="Home">Visit Website</a></button>
                </div>
            </div>
        </div>
        <!--Geometric Shape-->
        <div class="hero-slide">
            <img src="images/landing/iceil-landing/14.jpg" alt="Geometric">
            <div class="hero-slide-content">
                <h2>Geometric Shape</h2>
                <p>Iceil Geometric Shape Custom Lighting involves designing personalized lighting solutions using shapes like squares, triangles, circles, and others. These designs aim to enhance both the aesthetic appeal and practical functionality of indoor spaces, offering versatile and modern lighting options.
                </p>
                <div class="hero-buttons">
                    <button class="hero-btn"><a href="Geometrical">Click Here</a></button>
                    <button class="hero-btn"><a href="Home">Visit Website</a></button>
                </div>
            </div>
        </div>
        <!-- Art Perforated-->
        <div class="hero-slide">
            <img src="images/landing/iceil-landing/8.jpg" alt="Art Perforated">
            <div class="hero-slide-content">
                <h2>Art Perforated</h2>
                <p>Iceil Art Perforated Ceiling is an unique ambient ceiling solution, combining two stretch ceiling layer to create an eye-catching visual effect.
                </p>
                <div class="hero-buttons">
                    <button class="hero-btn"><a href="ArtPerforated">Click Here</a></button>
                    <button class="hero-btn"><a href="Home">Visit Website</a></button>
                </div>
            </div>
        </div>
		<!--Mirror-->
        <div class="hero-slide">
            <img src="images/landing/iceil-landing/9.jpg" alt="Mirror">
            <div class="hero-slide-content">
                <h2>Mirror</h2>
                <p>Iceil Mirror Stretch Ceiling enhances interior design with reflective surfaces, vi- sually enlarging spaces and creating a sleek, modern aesthetic controls.
                </p>
                <div class="hero-buttons">
                    <button class="hero-btn"><a href="Mirror">Click Here</a></button>
                    <button class="hero-btn"><a href="Home">Visit Website</a></button>
                </div>
            </div>
        </div>
		<!--Metal-->
        <div class="hero-slide">
            <img src="images/landing/iceil-landing/10.jpg" alt="Metal">
            <div class="hero-slide-content">
                <h2>Metal</h2>
                <p>Iceil Metal Perforated illuminated ceiling integrates perforated metal panels with embedded lighting elements, offering a unique blend of functionality and aesthetics.
                </p>
                <div class="hero-buttons">
                    <button class="hero-btn"><a href="Metal">Click Here</a></button>
                    <button class="hero-btn"><a href="Home">Visit Website</a></button>
                </div>
            </div>
        </div>
        <!--Signage Light Box-->
        <div class="hero-slide">
            <img src="images/landing/iceil-landing/11.jpg" alt="Signage Light Box">
            <div class="hero-slide-content">
                <h2>Signage Light Box</h2>
                <p>Iceil fabric signage light box offers a lightweight, durable, and vibrant solution for advertising. It features high-quality fabric stretched over a frame, providing easy installation and portability.
                </p>
                <div class="hero-buttons">
                    <button class="hero-btn"><a href="Fabric-Light-Boxes">Click Here</a></button>
                    <button class="hero-btn"><a href="Home">Visit Website</a></button>
                </div>
            </div>
        </div>
        <!--Wall Graphics-->
        <div class="hero-slide">
            <img src="images/landing/iceil-landing/12.jpg" alt="Wall Graphics">
            <div class="hero-slide-content">
                <h2>Wall Graphics</h2>
                <p>Iceil Custom Wall Graphics provide a uniquely personalized touch to your space, showcasing an image of your choice printed on premium fabric seam- lessly pasted onto your wall.
                </p>
                <div class="hero-buttons">
                    <button class="hero-btn"><a href="3DWallGraphics">Click Here</a></button>
                    <button class="hero-btn"><a href="Home">Visit Website</a></button>
                </div>
            </div>
        </div>
        ...
        <div class="hero-slide">
            <img src="images/landing/iceil-landing/13.jpg" alt="Architectural customised lighting">
            <div class="hero-slide-content">
                <h2>Architectural customised lighting</h2>
                <p>Iceil Architectural lights are constructed with lighting in combination with a suitable aluminium frame and a Polycarbonate diffusers / stretch fabric. We can customize this to any shape and size.
                </p>
                <div class="hero-buttons">
                    <button class="hero-btn"><a href="architectural-completed.php">Click Here</a></button>
                    <button class="hero-btn"><a href="Home">Visit Website</a></button>
                </div>
            </div>
        </div>
        <!--Iceil ARC/WAVE Linear-->
        <div class="hero-slide">
            <img src="images/landing/iceil-landing/15.jpg" alt="Iceil ARC/WAVE Linear">
            <div class="hero-slide-content">
                <h2>Iceil ARC/WAVE Linear</h2>
                <p>Iceil Arc/Wave linear lighting features designs that bend on both sides, offering flexible and dynamic illumination options. 
                </p>
                <div class="hero-buttons">
                    <button class="hero-btn"><a href="ARC">Click Here</a></button>
                    <button class="hero-btn"><a href="Home">Visit Website</a></button>
                </div>
            </div>
        </div>
        <!--Iceil Surface / -->
        <div class="hero-slide">
            <img src="images/landing/iceil-landing/16.jpg" alt="Iceil Surface / Suspended Linear">
            <div class="hero-slide-content">
                <h2>Iceil Surface / Suspended Linear</h2>
                <p>Iceil surface / suspended linear lighting offers bendable solutions to create versatile linear configurations.
                </p>
                <div class="hero-buttons">
                    <button class="hero-btn"><a href="Surface">Click Here</a></button>
                    <button class="hero-btn"><a href="Home">Visit Website</a></button>
                </div>
            </div>
        </div>
        <!--Iceil Curved Recessed -->
        <div class="hero-slide">
            <img src="images/landing/iceil-landing/linear.jpg" alt="Iceil Curved Recessed Linear">
            <div class="hero-slide-content">
                <h2>Iceil Curved Recessed Linear</h2>
                <p>Iceil curved recessed linear lighting seamlessly integrates into gypsum ceilings and offers the flexibility to be bent into various shapes.
                </p>
                <div class="hero-buttons">
                    <button class="hero-btn"><a href="Curved">Click Here</a></button>
                    <button class="hero-btn"><a href="Home">Visit Website</a></button>
                </div>
            </div>
        </div>
        <!--Iceil Outward / Inward / -->
        <div class="hero-slide">
            <img src="images/landing/iceil-landing/18.jpg" alt="Iceil Outward / Inward /  Downward Linear">
            <div class="hero-slide-content">
                <h2>Iceil Outward / Inward /  Downward Linear</h2>
                <p>Iceil outward / inward /downward linear lighting solutions are completely flexible, featuring bendable designs that allow for lighting in any direc- tion-upward, downward, inward, and outward.
                </p>
                <div class="hero-buttons">
                    <button class="hero-btn"><a href="Outward-Inward">Click Here</a></button>
                    <button class="hero-btn"><a href="Home">Visit Website</a></button>
                </div>
            </div>
        </div>
        <!--DIMMER-->
        <div class="hero-slide">
            <img src="images/landing/latest/DIMMER.jpg" alt="DIMMER">
            <div class="hero-slide-content">
                <div class="hero-buttons">
                    <button class="hero-btn"><a href="Translucent-Stretch-Ceilings">Click Here</a></button>
                    <button class="hero-btn"><a href="Home">Visit Website</a></button>
        ...
        <!--RGB W DMX-->
        <div class="hero-slide">
            <img src="images/landing/latest/RGB W DMX.jpg" alt="RGB W DMX">
            <div class="hero-slide-content">
                <div class="hero-buttons">
                    <button class="hero-btn"><a href="Translucent-Stretch-Ceilings">Click Here</a></button>
                    <button class="hero-btn"><a href="Home">Visit Website</a></button>
        ...
        <!--RGB WW-->
        <div class="hero-slide">
            <img src="images/landing/latest/RGB WW.jpg" alt="RGB WW">
            <div class="hero-slide-content">
                <div class="hero-buttons">
                    <button class="hero-btn"><a href="Translucent-Stretch-Ceilings">Click Here</a></button>
                    <button class="hero-btn"><a href="Home">Visit Website</a></button>
        ...
        <!--RGB-->
        <div class="hero-slide">
            <img src="images/landing/latest/RGB.jpg" alt="RGB">
            <div class="hero-slide-content">
                <div class="hero-buttons">
                    <button class="hero-btn"><a href="Translucent-Stretch-Ceilings">Click Here</a></button>
                    <button class="hero-btn"><a href="Home">Visit Website</a></button>
        ...
        <!--TUNABLE-->
        <div class="hero-slide">
            <img src="images/landing/latest/TUNABLE.jpg" alt="TUNABLE">
            <div class="hero-slide-content">
                <div class="hero-buttons">
                    <button class="hero-btn"><a href="Translucent-Stretch-Ceilings">Click Here</a></button>
                    <button class="hero-btn"><a href="Home">Visit Website</a></button>
    ...
    <div class="hero-arrow hero-left-arrow" onclick="prevHeroSlide()"><i class="fas fa-chevron-left"></i></div>
	<div class="hero-arrow hero-right-arrow" onclick="nextHeroSlide()"><i class="fas fa-chevron-right"></i></div>
	<div class="mry-slider-nav-panel d-flex">
		<!--fixed icons start-->
		<div class="d-flex justify-content-end">
			<div class="static-section-logo ">
