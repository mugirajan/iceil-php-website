									...
									<div class="mry-main-title-frame">
										<div class="container-fluid">
											<div class="mry-main-title" data-swiper-parallax-x="30%" data-swiper-parallax-scale=".7" data-swiper-parallax-opacity="0"
												...
												<div class="mry-text mry-mb-30"> Iceil Mirror Stretch Ceiling enhances interior design with reflective surfaces, vi- sually enlarging spaces and creating a sleek, modern aesthetic. controls.</div>
												<a class="mry-btn mry-default-link mry-anima-link" href="StretchCeiling">Click here</a>
												<a class="mry-btn-text mry-default-link mry-anima-link" href="Home">Visit Website</a>
											</div>
										</div>
									...
									<div class="mry-main-title-frame">
										<div class="container-fluid">
											<div class="mry-main-title" data-swiper-parallax-x="30%" data-swiper-parallax-scale=".7" data-swiper-parallax-opacity="0"
												...
												<div class="mry-text mry-mb-30"> Iceil Metal Perforated illuminated ceiling integrates perforated metal panels with embedded lighting elements,										 offering a unique blend of functionality and aesthetics.
												</div>
									...
									<div class="mry-main-title-frame">
										<div class="container-fluid">
											<div class="mry-main-title" data-swiper-parallax-x="30%" data-swiper-parallax-scale=".7" data-swiper-parallax-opacity="0"
												...
												<div class="mry-text mry-mb-30">Iceil outward / inward /downward linear lighting solutions are completely flexible, featuring bendable designs that allow for lighting in any direc- tion-upward, downward, inward, and outward.</div>
												<a class="mry-btn mry-default-link mry-anima-link" href="architectural-completed.php">Click here</a>
												<a class="mry-btn-text mry-default-link mry-anima-link" href="Home">Visit Website</a>
											</div>
										</div>
